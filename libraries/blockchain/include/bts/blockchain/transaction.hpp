...
namespace bts { namespace blockchain {
   ...
   struct transaction
   {
      ...
      void burn( const asset& quantity,
       ...
       void red_packet( const packet_id_type& random_id, const asset& asset_for_packet, account_id_type from_account_id, const string& message, const public_key_type& pub_key, uint32_t count, share_type renpin );
