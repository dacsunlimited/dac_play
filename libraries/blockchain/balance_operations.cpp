...
namespace bts { namespace blockchain {
   ...
   { try {
    ...
    { try {
        ...
        if( eval_state.pending_state()->get_head_block_num() >= PLS_V0_1_4_FORK_BLOCK_NUM )
        {
    ...
    { try {
        FC_ASSERT( eval_state.pending_state()->get_head_block_num() >= PLS_V0_2_0_FORK_BLOCK_NUM );
...
#ifndef WIN32
#warning [HARDFORK] Remove this check after PLS_V0_3_1_FORK_BLOCK_NUM has passed
#endif
        if ( eval_state.pending_state()->get_head_block_num() > PLS_V0_3_1_FORK_BLOCK_NUM )
        {
